...
const App = () => {
  ...
  const getCSRF = () => {
    ...
    .then(() => {
      ...
      if(!csrfToken) {
        setError("CSRF cookie not set. Please refresh the page and check your cookie settings if this message persists.");
      }
    ...
    .catch((err) => {
      ...
      if(err.message?.includes("NetworkError")) {
        setError("Unable to contact server. Please check your connection and refresh.");
      };
      if(err.message?.includes("The operation was aborted")) {
        setError("Timeout connecting to server. Please check your connection and refresh.");
      }
      setLoading(false);
    });
  }    
